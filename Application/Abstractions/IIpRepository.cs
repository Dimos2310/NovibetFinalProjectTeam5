...
namespace Application.Abstractions;
    public interface IIpRepository
    {
        ...
        Task<IReadOnlyList<ReportRow>> GetReportAsync(string[]? countryCodes, CancellationToken ct = default); // report for the countries, readonly because we do not want to modify data
    }